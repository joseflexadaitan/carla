...
This section will cover spawning, destruction, types, and how to manage them. However, the possibilities are almost endless. Experiment, take a look at the __tutorials__ in this documentation and share questions and ideas in the [CARLA forum](https://github.com/carla-simulator/carla/discussions/).  
